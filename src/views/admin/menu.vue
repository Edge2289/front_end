  ...
  <div class="app-container">
    <el-form :inline="true">
      ...
      <el-form-item label="状态">
        <el-select v-model="queryParams.is_used" placeholder="菜单状态" clearable size="small">
          <el-option
    ...
    <el-dialog v-dialogDrag :title="title" :visible.sync="open" width="600px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item v-if="form.is_used != 'F'" label="菜单状态">
              <el-radio-group v-model="form.visible">
                <el-radio key="1" label="开启">开启</el-radio>
                <el-radio key="0" label="关闭">关闭</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
        </el-row>
...
<script>
import { getMenuList, saveMenuData, changeMenuData, delMenuData } from '@/api/manage/menu'
