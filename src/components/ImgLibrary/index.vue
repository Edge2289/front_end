  ...
  >
    ...
    >
      ...
      >
        <div
          :id="-1"
          :class="{ img_menu_xuanzhong: searchSelectedGroup == -1 }"
        ...
        <div
          :id="0"
          :class="{ img_menu_xuanzhong: searchSelectedGroup == 0 }"
          style="margin-left: 12px; cursor: pointer"
          @click="selectGroup(0)"
          @mouseover="changeActive($event)"
          @mouseout="removeActive($event)"
        ...
        <div
          ...
          :id="itemGroup.id"
          :key="indexGroup"
          :class="{ img_menu_xuanzhong: searchSelectedGroup == itemGroup.id }"
          style="cursor: pointer"
          @click="selectGroup(itemGroup.id)"
          @mouseover="changeActive($event)"
          @mouseout="removeActive($event)"
        >
          <a
            style="cursor: pointer; position: absolute; left: 0.6rem"
            class="groupTextHidden"
            @click="editGroupText(itemGroup)"
          >
          ...
          <a
            ...
            class="groupTextHidden"
            @click="delGroupText(itemGroup)"
          >
            <i class="el-icon-delete" />
          </a>
        </div>
        <div
          style="margin-left: 12px; text-decoration: underline"
          @click="newGroup()"
        >
          <a>新增分组</a>
        </div>
      ...
      <el-container>
        <el-header style="height: 36px; font-size: 12px">
          <el-row>
            <el-col :span="12">
              ...
              <el-button type="danger" size="mini" @click="delImgs"
                >删除</el-button
              >
            </el-col>
        ...
        <el-main v-loading="imgLoadingShow">
          ...
          <div
            ...
            :imgUrl="imgItem.url"
            class="block"
            style="width: 23%; padding: 2px"
            @click="clickImgs($event)"
          >
            <div class="img-paixun">
              ...
              <div
                class="demonstration"
                style="text-align: center; overflow: hidden; height: 16px"
              >
                {{ imgItem.name }}
              </div>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="dialogVisibleMethod(1)"
        >确 定</el-button
      >
    </span>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button
          type="primary"
          @click="groupNewEdit()"
          :loading="newEditGroupTextLoadingbut"
          >确 定</el-button
        >
